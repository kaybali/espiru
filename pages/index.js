...
import { LucideVenus, LucideMars, LucideGenderNonBinary } from "lucide-react";
      ...
      {step === 0 && (
        <div className="max-w-xl text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <LucideVenus className="w-6 h-6" /> Feminino
            </button>
            <button
              onClick={() => handleSelectGender("Masculino")}
              className="bg-[#1a2e40] hover:bg-[#274862] px-6 py-4 rounded-xl flex items-center justify-center gap-2 w-full sm:w-auto"
            >
              <LucideMars className="w-6 h-6" /> Masculino
            </button>
            <button
              onClick={() => handleSelectGender("Não-binário")}
              className="bg-[#1a2e40] hover:bg-[#274862] px-6 py-4 rounded-xl flex items-center justify-center gap-2 w-full sm:w-auto"
            >
              <LucideGenderNonBinary className="w-6 h-6" /> Não-binário
            </button>
          </div>
        </div>
      )}
